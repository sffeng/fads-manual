...
Welcome to the FADS (**F**eng **A**rtificial intelligence **D**ecision **S**ystems[^1]) research group  at Sorbonne University Abu Dhabi. We are a research group that bridges mathematics, cognitive science, AI, and systems design in order to build and augment interpretable, process-aware AI tools for real-world decision-making.

I'm Dr. Samuel F. Feng (students call me "Dr. Sam" and colleagues call me "Sam"). This document provides expectations and research principles for anyone getting started with my research group. I tend to introduce this as early as possible to save frustration and confusion.

This manual is inspired by an article (https://doi.org/10.1038/d41586-018-06167-w) written by my former collaborator Mariam Aly.  
