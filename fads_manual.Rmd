...
Welcome to the FADS (**F**eng **A**rtificial intelligence **D**ecision **S**ystems[^1]) research group  at Sorbonne University Abu Dhabi. We are a research group that bridges mathematics, AI, and systems design in order to build and augment interpretable, process-aware AI tools for real-world decision-making.
